...
export const Scene06Featured: React.FC = () => {
  ...
  return (
    <section
      ...
      className="relative min-h-[90vh] flex flex-col justify-center px-4 py-24 border-b border-[var(--border-subtle)] bg-[var(--bg-elevated)]"
    >
      <motion.div
        style={{ opacity: prefersReducedMotion ? 1 : opacity }}
        className="mx-auto max-w-7xl w-full space-y-12"
      >
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-[var(--border-subtle)] pb-6">
          <div className="space-y-2">
            ...
            <h2 className="text-3xl font-extrabold text-[var(--text-primary)] font-heading tracking-tight">
